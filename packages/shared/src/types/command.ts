...
export const SLASH_COMMANDS: readonly SlashCommand[] = [
  ...
  { name: '/connect', description: 'プロバイダー追加 (認証連携)', available: false },
  { name: '/theme', description: 'テーマ切替 (ダークモード等)', available: true },
  { name: '/thinking', description: '思考ブロック表示の ON/OFF 切替', available: true },
  { name: '/undo', description: '元に戻す (ファイル変更含む・要 Git)', available: false },
  { name: '/redo', description: 'やり直し (/undo 後のみ有効)', available: false },
